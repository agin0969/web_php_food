                    ...
                    <tbody>
                        <?php foreach ($users as $user): ?>
                            <tr>
                                ...
                                <td><!-- Add your actions/buttons here -->
                            
                                <div class="col ml-1">
                    <?php $id = $user->getId(); ?>
                    <form id="form-delete-<?= $id ?>" action="../controllers/userDelCon.php" method="get">
                        <input type="hidden" name="id" value="<?= $id ?>">
                        <button class="btn btn-outline-success" type="button" onclick="confirmDelete('form-delete-<?= $id ?>')">Xóa</button>
                    </form>
                                </div>
                     <div class="col ml-1">
                   <button class="btn btn-outline-success" type="button" data-bs-toggle="modal" data-bs-target="#userEditModal"
                    onclick="setUserId('<?php echo $user->getId(); ?>')">Sửa</button>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3 row">
                    ...
                    <input type="text" id="id" name="id" class="form-control col"
                        placeholder="nhập id">
                </div>
                <div class="mb-3 row">
            ...
            <div class="modal-footer">
                ...
                <input type="submit" class="btn btn-primary" type="submit" value="Lưu thay đổi"
                                        name="submit">         
                        </div>
            </form>
        </div>
